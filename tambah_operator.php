...
$upload_member=mysql_query("insert into password value ('$username','$password','Operator')");
if ($upload_database and $upload_member){echo "<script> alert('Berhasil Tambah Operator !! '); document.location.href='index.php?menu=home'; </script>";} else { echo "<script> alert('Gagal Daftar !! Coba ulangi !!'); document.location.href='index.php?menu=registration'; </script>";}
}
?>
